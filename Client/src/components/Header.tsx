const Header = () => {
    return (
        <header className="relative flex items-center justify-between px-8 py-5 bg-gradient-to-r from-[#0F172A] to-[#1D4ED8] z-10">
            ...
            <div className="flex items-center relative">
                ...
                <span className="font-bold text-white text-xl tracking-tight">Pet Agent</span>
            </div>
